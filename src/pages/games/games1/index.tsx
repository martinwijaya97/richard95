...
const ListGames = () => {
  ...
  const create = (scene: Phaser.Scene) => {
    ...
    const text = scene.add
      .text(centerX, centerY + radius + 50, 'Press Space or Button to Start', {
        fontSize: '18px',
        color: '#ffffff',
    ...
    const image = scene.add
      .image(centerX, centerY, 'center-image')
    ...
    const button = scene.add
      .text(centerX, centerY + radius + 100, '▶ Start', {
        fontSize: '22px',
        backgroundColor: '#333',
        color: '#fff',
        padding: { x: 20, y: 10 },
    ...
    const button_reset = scene.add
      .text(centerX, centerY + radius + 150, '🔄 Reset', {
        fontSize: '20px',
        backgroundColor: '#666',
        color: '#fff',
        padding: { x: 18, y: 8 },
